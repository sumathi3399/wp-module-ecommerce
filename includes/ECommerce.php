...
class ECommerce {
	...
	public function regiester_site_preview() {
		$is_coming_soon   = 'true' === get_option( 'nfd_coming_soon', 'false' );
		if($is_coming_soon){
		echo '<div style="background-color: #e71616; padding: 0 16px;color:#ffffff;font-size:16px;text-align:center;font-weight: 590;">';
		echo esc_html__( 'Site Preview - This site is NOT LIVE, only admins can see this view.', 'wp-module-ecommerce' );
		echo '</div>';
		}
	}
}
